...
<img src="https://demo1.leotheme.com/bos_soucer_demo/304-cart_default/eiusmod-tempor.jpg" alt="Eiusmod tempor"/>
</span>
</div>

<div className="product-line-grid-body col-md-4 col-xs-8">
<div className="product-line-info">
<a className="label" href="https://demo1.leotheme.com/bos_soucer_demo/en/basics/2-7-eiusmod-tempor.html#/1-size-s/11-color-black" data-id_customization="0">Eiusmod tempor</a>
</div>
